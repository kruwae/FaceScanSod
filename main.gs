...
function dispatchAction(action, params, method) {
  ...
  else if (action === 'saveConfig') result = saveConfig(params.apiUrl, params.locations, params.workTimes, params.fallbackSettings, params.updatedBy, params.token, params.scanMode, params.faceMatchThreshold);
